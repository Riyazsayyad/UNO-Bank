...
/**
 * Servlet implementation class Drawinout
 */
@WebServlet("/Drawinout")
public class Drawinout extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			if(cnt>0)
			{
		        ...
		        htmlRespone += " <h3><a href='Cashier.jsp'>Click here to go back to Dashboard page.<a></h3>";
		        htmlRespone += "</html>";
