...
<section>
    ...
    <div class="flex flex-col text-center w-full mb-12">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">Edit Status</h1>
    ...
    <div class="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:px-0">
      ...
      <input class="flex-grow w-full bg-gray-100 rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 mr-4 mb-4 sm:mb-0" name="offstat" placeholder=" Enter Account Number" type="text" autocomplete="off" required>
     &nbsp;&nbsp;&nbsp;&nbsp;
      <div>
  <select class="browser-default custom-select custom-select-lg mb-3" name="onstat" required>
