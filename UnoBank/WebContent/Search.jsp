...
<section>
    ...
    <div class="flex lg:w-2/3 w-full sm:flex-row flex-col mx-auto px-8 sm:px-0">
      ...
      <input class="flex-grow w-full bg-gray-100 rounded border border-gray-400 focus:outline-none focus:border-indigo-500 text-base px-4 py-2 mr-4 mb-4 sm:mb-0" name="search" placeholder=" Enter Account Number" type="text" autocomplete="off" required>
     &nbsp;&nbsp;&nbsp;&nbsp;
      <div>
